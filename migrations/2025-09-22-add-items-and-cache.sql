-- Миграция: добавление таблиц для нормализованных позиций и кэша LLM
-- Дата: 2025-09-22
-- Цель: подготовить БД для парсинга и подсчёта КБЖУ

-- 1) Таблица нормализованных позиций внутри записи
...
-- 2) Кэш для LLM-ответов (пер100г, плотности, типовой вес порции и пр.)
